...
<div class="container-fluid">
	...
	<p class="lead">
		Bienvenido a la sección de actualización de los datos de los administradores. Acá podrá actualizar la información personal de los administradores del sistema
	</p>
</div>
<?php 
	...
	$data=$insAdmin->data_admin_controller("Only",$code[1]);
	if($data->rowCount()>0):
		$rows=$data->fetch();
?>
<p class="text-center">
	<a href="<?php echo SERVERURL; ?>adminlist/" class="btn btn-info btn-raised btn-sm">
